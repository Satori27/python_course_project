...
RECOMMENDATION_SERVICE_URL = os.environ.get('RECOMMENDATION_SERVICE_URL', "http://localhost:8001/recommendation")
RECOMMENDATION_SERVICE_URL+=":8000"
...
async def get_movie_recommendations(
    ...
    try:
        ...
        async with httpx.AsyncClient() as client:
            print(f"http://{RECOMMENDATION_SERVICE_URL}/recommendation/{user_id}")
            response = await client.get(f"http://{RECOMMENDATION_SERVICE_URL}/recommendation/{user_id}")
